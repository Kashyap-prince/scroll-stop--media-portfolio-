          ...
          <form onSubmit={handleFormSubmit} className="bg-slate-800/40 border border-slate-700/50 rounded-xl p-8 space-y-6">
            ...
            <div>
              ...
              >
                ...
                <option value="script">AI Script (₹400-500)</option>
                <option value="prompt">Prompt Engineering (₹300)</option>
                <option value="caption">Captions & Copy (₹200+)</option>
                <option value="thumbnail">Thumbnails (₹150+)</option>
                <option value="blog">Blog Post (₹250+)</option>
                <option value="bundle">2 Scripts Bundle (₹720)</option>
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Describe your project, audience, style, and any specific requirements..."
              />
            </div>

            <button
              type="submit"
              className="w-full py-4 bg-gradient-to-r from-blue-500 to-purple-500 rounded-lg font-semibold hover:shadow-xl hover:shadow-blue-500/50 transition-all"
            >
              Send Inquiry
            </button>

            <p className="text-center text-sm text-slate-400">
              Or email me directly at <a href="mailto:fair9727@gmail.com" className="text-blue-400 hover:text-blue-300">fair9727@gmail.com</a>
            </p>
          </form>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="text-center text-slate-400">
              <p className="mb-2">Love Kashyap • AI Content Creator</p>
              <p className="text-sm">Scripts • Prompts • Captions • Thumbnails • Blogs</p>
            </div>
            <a href="mailto:fair9727@gmail.com" className="flex items-center gap-2 text-blue-400 hover:text-blue-300 transition-colors">
              <Mail className="w-5 h-5" />
              fair9727@gmail.com
            </a>
          </div>
          <div className="border-t border-slate-800/50 mt-8 pt-8 text-center text-sm text-slate-500">
            <p>© 2024 ScrollStop Media. All rights reserved.</p>
          </div>
        </div>
      </footer>
